...
//    public static final RegistryObject<Block> STEEL_WIRE_SHELF = registerWithItem("steel_wire_shelf", () -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(2.0F, 3.0F).harvestTool(ToolType.PICKAXE).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> BIG_MIXED_STONE_SLAB = registerWithItem("big_mixed_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_STONE_STAIRS = registerWithItem("big_mixed_stone_stairs", () -> new StairsBlock(() -> BIG_MIXED_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_STONE_WALL = registerWithItem("big_mixed_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_STONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_RED_SANDSTONE_SLAB = registerWithItem("big_mixed_red_sandstone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_RED_SANDSTONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_RED_SANDSTONE_STAIRS = registerWithItem("big_mixed_red_sandstone_stairs", () -> new StairsBlock(() -> BIG_MIXED_RED_SANDSTONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_RED_SANDSTONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_RED_SANDSTONE_WALL = registerWithItem("big_mixed_red_sandstone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_RED_SANDSTONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_SANDSTONE_SLAB = registerWithItem("big_mixed_sandstone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_SANDSTONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_SANDSTONE_STAIRS = registerWithItem("big_mixed_sandstone_stairs", () -> new StairsBlock(() -> BIG_MIXED_SANDSTONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_SANDSTONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_SANDSTONE_WALL = registerWithItem("big_mixed_sandstone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_SANDSTONE.get())));
    ...
    public static final RegistryObject<Block> MIXED_BLACK_STONE_SLAB = registerWithItem("mixed_black_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(MIXED_BLACK_STONE.get())));
    public static final RegistryObject<Block> MIXED_BLACK_STONE_STAIRS = registerWithItem("mixed_black_stone_stairs", () -> new StairsBlock(() -> MIXED_BLACK_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(MIXED_BLACK_STONE.get())));
    public static final RegistryObject<Block> MIXED_BLACK_STONE_WALL = registerWithItem("mixed_black_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(MIXED_BLACK_STONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_BLACK_STONE_SLAB = registerWithItem("big_mixed_black_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_BLACK_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_BLACK_STONE_STAIRS = registerWithItem("big_mixed_black_stone_stairs", () -> new StairsBlock(() -> BIG_MIXED_BLACK_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_BLACK_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_BLACK_STONE_WALL = registerWithItem("big_mixed_black_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_BLACK_STONE.get())));
    ...
    public static final RegistryObject<Block> MIXED_DARK_STONE_SLAB = registerWithItem("mixed_dark_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(MIXED_DARK_STONE.get())));
    public static final RegistryObject<Block> MIXED_DARK_STONE_STAIRS = registerWithItem("mixed_dark_stone_stairs", () -> new StairsBlock(() -> MIXED_DARK_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(MIXED_DARK_STONE.get())));
    public static final RegistryObject<Block> MIXED_DARK_STONE_WALL = registerWithItem("mixed_dark_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(MIXED_DARK_STONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_DARK_STONE_SLAB = registerWithItem("big_mixed_dark_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_DARK_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_DARK_STONE_STAIRS = registerWithItem("big_mixed_dark_stone_stairs", () -> new StairsBlock(() -> BIG_MIXED_DARK_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_DARK_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_DARK_STONE_WALL = registerWithItem("big_mixed_dark_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_DARK_STONE.get())));
    ...
    public static final RegistryObject<Block> MIXED_RIVER_STONE_SLAB = registerWithItem("mixed_river_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(MIXED_RIVER_STONE.get())));
    public static final RegistryObject<Block> MIXED_RIVER_STONE_STAIRS = registerWithItem("mixed_river_stone_stairs", () -> new StairsBlock(() -> MIXED_RIVER_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(MIXED_RIVER_STONE.get())));
    public static final RegistryObject<Block> MIXED_RIVER_STONE_WALL = registerWithItem("mixed_river_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(MIXED_RIVER_STONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_RIVER_STONE_SLAB = registerWithItem("big_mixed_river_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_RIVER_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_RIVER_STONE_STAIRS = registerWithItem("big_mixed_river_stone_stairs", () -> new StairsBlock(() -> BIG_MIXED_RIVER_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_RIVER_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_RIVER_STONE_WALL = registerWithItem("big_mixed_river_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_RIVER_STONE.get())));
    ...
    public static final RegistryObject<Block> MIXED_WHITE_STONE_SLAB = registerWithItem("mixed_white_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(MIXED_WHITE_STONE.get())));
    public static final RegistryObject<Block> MIXED_WHITE_STONE_STAIRS = registerWithItem("mixed_white_stone_stairs", () -> new StairsBlock(() -> MIXED_WHITE_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(MIXED_WHITE_STONE.get())));
    public static final RegistryObject<Block> MIXED_WHITE_STONE_WALL = registerWithItem("mixed_white_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(MIXED_WHITE_STONE.get())));
    ...
    public static final RegistryObject<Block> BIG_MIXED_WHITE_STONE_SLAB = registerWithItem("big_mixed_white_stone_slab", () -> new SlabBlock(AbstractBlock.Properties.copy(BIG_MIXED_WHITE_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_WHITE_STONE_STAIRS = registerWithItem("big_mixed_white_stone_stairs", () -> new StairsBlock(() -> BIG_MIXED_WHITE_STONE.get().defaultBlockState(), AbstractBlock.Properties.copy(BIG_MIXED_WHITE_STONE.get())));
    public static final RegistryObject<Block> BIG_MIXED_WHITE_STONE_WALL = registerWithItem("big_mixed_white_stone_wall", () -> new WallBlock(AbstractBlock.Properties.copy(BIG_MIXED_WHITE_STONE.get())));
    ...
    public static final RegistryObject<Block> HEAVY_DUTY_BARS_DOOR = registerWithItem("heavy_duty_bars_door", () -> new DoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> HEAVY_DUTY_BARS_FENCE = registerWithItem("heavy_duty_bars_fence", () -> new PaneBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> HEAVY_DUTY_BARS_SLAB = registerWithItem("heavy_duty_bars_slab", () -> new SlabBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> HEAVY_DUTY_BARS_TRAPDOOR = registerWithItem("heavy_duty_bars_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion().isValidSpawn(ZFCBlocks::neverSpawns)));
    ...
    public static final RegistryObject<Block> VERTICAL_BARS_DOOR = registerWithItem("vertical_bars_door", () -> new DoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> VERTICAL_BARS_FENCE = registerWithItem("vertical_bars_fence", () -> new PaneBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> VERTICAL_BARS_SLAB = registerWithItem("vertical_bars_slab", () -> new SlabBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> VERTICAL_BARS_TRAPDOOR = registerWithItem("vertical_bars_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion().isValidSpawn(ZFCBlocks::neverSpawns)));
    ...
    public static final RegistryObject<Block> CAST_IRON_BARS_DOOR = registerWithItem("cast_iron_bars_door", () -> new DoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> CAST_IRON_BARS_FENCE = registerWithItem("cast_iron_bars_fence", () -> new PaneBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> CAST_IRON_BARS_SLAB = registerWithItem("cast_iron_bars_slab", () -> new SlabBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(2.0F, 3.0F).sound(SoundType.METAL).noOcclusion()));
    public static final RegistryObject<Block> CAST_IRON_BARS_TRAPDOOR = registerWithItem("cast_iron_bars_trapdoor", () -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(3.0F).sound(SoundType.METAL).noOcclusion().isValidSpawn(ZFCBlocks::neverSpawns)));
